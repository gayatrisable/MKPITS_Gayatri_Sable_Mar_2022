...
namespace a7.object_rno_name_mathsmarks_
{//A5.7 create a class student having fields rno, name, mathsmarks, chemmarks, phymarks, total, per, grade and method result to calculate and display total, per and grade
